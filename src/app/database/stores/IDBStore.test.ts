...
describe("IDBStore", () => {
    ...
    it("should push data into a table and persist it", async () => {
        ...
        const newStore = new IDBStore({ tables: ["users", "posts"], name: "testDB" });
        await newStore.load();
    ...
    it("should unshift data into a table and persist it", async () => {
        const userData1 = { id: "user1", name: "John Doe", active: true };
        const userData2 = { id: "user2", name: "Jane Doe", active: false };
