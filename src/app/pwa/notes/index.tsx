        ...
        <div className='w-full flex flex-row'>
            <div className='flex flex-row h-fit'>
                ...
                <button
                    ...
                    onClick={() =>
                        saveAction(editor?.getHTML(), editor?.getText())
                    }
                >
                    <BsFloppy />
                </button>
...
export function NoteBrowser({
    ...
    const groupedNotes = notes.reduce<Record<string, NoteType[]>>(
        (acc, note) => {
...
export function NoteEditor({
    ...
    return (
        <div className='flex flex-col h-full w-full'>
            ...
            <EditorContent
                editor={editor}
                className='h-full px-1 overflow-auto'
            />
        </div>
    );
}
    ...
    return (
        <div className='flex flex-row h-full w-full overflow-hidden'>
            ...
            <NoteEditor
                ...
                backAction={
                    sidebarOpen ? () => setSidebarOpen(false) : undefined
                }
                leftSideAction={
                    !sidebarOpen ? () => setSidebarOpen(true) : undefined
                }
            />
        </div>
    );
